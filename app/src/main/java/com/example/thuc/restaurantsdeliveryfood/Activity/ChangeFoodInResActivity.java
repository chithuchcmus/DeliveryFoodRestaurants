...
public class ChangeFoodInResActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameFoodET = (EditText) findViewById(R.id.edit_food_name);
        priceFoodET = (EditText)findViewById(R.id.edit_food_price);
        foodImage = (ImageView) findViewById(R.id.edit_food_image);
        buttonFindNewImage = (Button)findViewById(R.id.edit_food_image_button);
        startEditFood = (Button)findViewById(R.id.start_edit_food_button);
        loadData();
        ...
        startEditFood.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onUpload();
            }
        ...
        if(!checkInput())
        {
            ...
            retrofit.create(CvlApi.class).EditFood(food).enqueue(new Callback<Food>() {
                ...
                public void onResponse(Call<Food> call, Response<Food> response) {
                    ...
                    {
                        ChangeFoodInResActivity.this.setResult(MainActivity.EDIT_FOOD_SUCCES, rslt_int);
                    }
                    else
                    {
                        ChangeFoodInResActivity.this.setResult(MainActivity.EDIT_FOOD_FAIL, rslt_int);
                    }
                    finish();
                }
    ...
    private void onUpload() {
        if (chosenFile == null)
        {
            Toast.makeText(ChangeFoodInResActivity.this, "Choose a file before upload.", Toast.LENGTH_SHORT)
                    .show();
            return;
        }
        ...
        if (requestCode == PICK_IMAGE_TO_EDIT && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                if (!permissionsList.isEmpty())
                    ActivityCompat.requestPermissions(ChangeFoodInResActivity.this,
        ...
        switch (requestCode) {
            case READ_WRITE_EXTERNAL: {
                ...
                if (perms.get(Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED
                    ...
                    Toast.makeText(ChangeFoodInResActivity.this, "All Permission are granted.", Toast.LENGTH_SHORT)
                            .show();
                    getFilePath();
                } else {
                    Toast.makeText(ChangeFoodInResActivity.this, "Some permissions are denied", Toast.LENGTH_SHORT)
                            .show();
                }
                return;
            }
